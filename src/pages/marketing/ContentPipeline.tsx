      ...
      <div className={`px-8 py-4 border-b flex items-center justify-between ${isDarkMode ? 'bg-[#0a0a0f]/50 border-white/5' : 'bg-white border-slate-200'}`}>
        ...
        <div className="flex items-center gap-3">
           <div className="relative">
              ...
              <input type="text" placeholder="Filtrar contenido..." className="bg-white/5 border border-white/10 rounded-lg pl-9 pr-4 py-1.5 text-xs text-white outline-none focus:border-brand-500 transition-all" />
           </div>
              ...
              <div key={column.id} className="w-[320px] flex flex-col h-full max-h-full">
                <div className="flex items-center justify-between mb-4 px-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] bg-white/5 text-slate-500 px-1.5 py-0.5 rounded-md font-bold">
